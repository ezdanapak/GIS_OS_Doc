...
```markdown
# ტესტები 15 ფუნქციისთვის (`def`-ით)

ქვემოთ მოცემულია **ტესტები** თითოეული ამოცანისთვის.  
შეგიძლიათ გამოიყენოთ ეს კოდი **ფუნქციების შემოწმებისთვის** — უბრალოდ ჩააწერეთ თქვენი ფუნქციები და გაუშვით.
