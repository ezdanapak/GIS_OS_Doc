...
მიზანი: პროგრამა რიცხვების შეკრებას აგრძელებს მანამ, სანამ ცვლადი current_number არ გახდება $10$-ზე მეტი ან ნულზე ნაკლები. გამოიყენეთ while ციკლი.Python# while ციკლის გამოყენება
...
მიზანი: დაბეჭდეთ რიცხვები $1$-დან $25$-მდე. თუ რიცხვი $5$-ის ჯერადია (იყოფა $5$-ზე უნაშთოდ), გამოტოვეთ მისი დაბეჭდვა continue ოპერატორის გამოყენებით.Pythonstart = 1
```python
end = 25
...
მიზანი: დაიწყეთ რიცხვით $2$. გააგრძელეთ მისი გამრავლება $3$-ზე მანამ, სანამ შედეგი არ იქნება $50$-ზე მეტი. დათვალეთ, რამდენჯერ მოხდა გამრავლება.Pythonnumber = 2
...
მიზანი: მოცემულია სტრინგი "Georgia". for ციკლით გაიარეთ მისი ყველა სიმბოლო. თუ სიმბოლოს ინდექსი (თანმიმდევრობის ნომერი, 0-დან დაწყებული) არის ლუწი, დაბეჭდეთ იგი.Pythonword = "Georgia"
