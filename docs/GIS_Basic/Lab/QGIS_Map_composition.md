...
ხელსაწყო რასტრის გაერთიანება - [Merge](https://docs.qgis.org/3.40/en/docs/training_manual/map_composer/map_composer.html) <br>
...
<br>
* გახსენით Layout გაფორმების რეჟიმი
<br>
++left-control+"P"++
<br>
